...
export default class Logo extends React.Component {
  ...
  initAnimation() {
    ...
    /**
     * I don't know how to decompose this into a separate method
     */
    function init() {
      introAnimation.play();
      ...
      <div className="logo">
        <div className="animation-wrapper">
         <div className="sphere-animation">
           <svg className="sphere" viewBox="0 0 440 440" stroke="rgba(255,255,255,.35)">
      <defs>
      <linearGradient id="sphereGradient" x1="5%" x2="5%" y1="0%" y2="15%">
      <stop stopColor="#373734" offset="0%"/>
      <stop stopColor="#9CC7D7" offset="50%"/>
      <stop stopColor="#B6EBFC" offset="100%"/>
      </linearGradient>
      </defs>
